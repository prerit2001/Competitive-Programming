...
*/
	...
	// void BottomView(Node *root, int level, int horizontal_scale){
	// 	if(root == NULL) return;
	...
	// 		}
	// 	}
	// 	BottomView(root -> left, level + 1, horizontal_scale - 1);
	// 	BottomView(root -> right, level + 1, horizontal_scale + 1);
	// }
	// int main(){
